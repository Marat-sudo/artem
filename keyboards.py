...
# def basket(id):
#     values = db.select_all_basket(id)
#     kbd = types.InlineKeyboardMarkup(row_width=2)
#     b1 = types.InlineKeyboardButton(values[0][1], callback_data='products_' + str(values[0][0]))
#     b2 = types.InlineKeyboardButton(values[1][1], callback_data='products_' + str(values[1][0]))
#     b3 = types.InlineKeyboardButton(values[2][1], callback_data='products_' + str(values[2][0]))
#     b4 = types.InlineKeyboardButton(values[3][1], callback_data='products_' + str(values[3][0]))
#     b5 = types.InlineKeyboardButton(values[4][1], callback_data='products_' + str(values[4][0]))
#     b6 = types.InlineKeyboardButton(values[5][1], callback_data='products_' + str(values[5][0]))
#     b7 = types.InlineKeyboardButton("<", callback_data='page_-1_' + str(page))
#     b8 = types.InlineKeyboardButton("назад", callback_data='page_cat')
#     b9 = types.InlineKeyboardButton(">", callback_data='page_+1_' + str(page))
#     kbd.add(b1, b2, b3, b4, b5, b6)
